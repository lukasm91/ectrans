...
IF(PRESENT(PGP)) THEN
  ...
  IF(IUBOUND(2) /= IF_GP) THEN
    ...
    CALL ABORT_TRANS('INV_TRANS:SECOND DIMENSION OF PGP TOO SMALL/LARGE ')
  ENDIF
...
IF(IF_SC3B_G3 > 0) THEN
  IF(PRESENT(PGP3B)) THEN
    ...
    ENDIF
    IF(IUBOUND(4) /= NGPBLKS) THEN
      WRITE(NOUT,*)'INV_TRANS:FOURTH DIM. OF PGP3B TOO SMALL/LARGE ',IUBOUND(4),NGPBLKS
      CALL ABORT_TRANS('INV_TRANS:FOURTH DIMENSION OF PGP3B TOO SMALL/LARGE ')
    ENDIF
  ELSE
