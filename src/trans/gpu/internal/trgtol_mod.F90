  ...
  SUBROUTINE TRGTOL(ALLOCATOR,HTRGTOL,PREEL_REAL,KF_FS,KF_GP,KF_UV_G,KF_SCALARS_G,&
    ...
    DO INR=1,IRECV_COUNTS
      ...
      IF (IRECV /= MYPROC) THEN
        ...
        CALL MPI_IRECV(ZCOMBUFR(ICOMBUFR_OFFSET(INR)+1:ICOMBUFR_OFFSET(INR+1)),INT(IRECVTOT(IRECV),JPIM), &
          & TRGTOL_DTYPE,NPRCIDS(IRECV)-1,MTAGLG,MPL_COMM_OML(OML_MY_THREAD()),IREQ(IR),IERROR)
      ENDIF
    ENDDO
