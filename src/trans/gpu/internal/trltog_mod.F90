...
CONTAINS
  ...
  SUBROUTINE TRLTOG_CUDAAWARE(ALLOCATOR,HTRLTOG,PREEL_REAL,KF_FS,KF_GP,KF_UV_G,KF_SCALARS_G,KPTRGP,&
    ...
    LOGICAL :: LUPDATE_PGP, LUPDATE_PGPUV, LUPDATE_PGP2, LUPDATE_PGP3A, LUPDATE_PGP3B
    ...
    !$ACC DATA COPYIN(IIN_TO_SEND_BUFR) PRESENT(PREEL_REAL) IF(KF_FS > 0)
    CALL GSTATS(1806,1)
    ...
    !$ACC DATA PRESENT(ZCOMBUFS) IF(ISEND_COUNTS > 0)
    CALL GSTATS(1605,0)
    ...
    !$ACC DATA PRESENT(ZCOMBUFR) IF(IRECV_COUNTS > 0)
    CALL GSTATS(805,1)
