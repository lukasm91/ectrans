...
INTEGER, PARAMETER :: NH2D = CUDAMEMCPYHOSTTODEVICE , ND2H = CUDAMEMCPYDEVICETOHOST
...
CONTAINS
  ...
  SUBROUTINE COPY_2_REAL_4_2D(DST, SRC, KDIR, QUEUE)
    ...
    INTEGER(KIND=8) :: IWIDTH, IHEIGHT, ISHP_SRC(3), ISHP_DST(3)
    INTEGER(KIND=8) :: ISTRIDES_SRC(2), ISTRIDES_DST(2)
  ...
  SUBROUTINE COPY_3_REAL_4_2D(DST, SRC, KDIR, QUEUE)
    ...
    INTEGER :: IRET
    INTEGER :: IPITCH_DST, IPITCH_SRC
    INTEGER(KIND=8) :: IWIDTH, IHEIGHT, ISHP_SRC(4), ISHP_DST(4)
    INTEGER(KIND=8) :: ISTRIDES_SRC(3), ISTRIDES_DST(3)
    INTEGER(KIND=CUDA_STREAM_KIND) :: STREAM
    TYPE(C_PTR) :: HSTPTR
    TYPE(C_DEVPTR) :: DEVPTR
  ...
  SUBROUTINE COPY_4_REAL_4_2D(DST, SRC, KDIR, QUEUE)
    ...
    INTEGER :: IRET
    INTEGER :: IPITCH_DST, IPITCH_SRC
    INTEGER(KIND=8) :: IWIDTH, IHEIGHT, ISHP_SRC(5), ISHP_DST(5)
    INTEGER(KIND=8) :: ISTRIDES_SRC(4), ISTRIDES_DST(4)
    INTEGER(KIND=CUDA_STREAM_KIND) :: STREAM
    TYPE(C_PTR) :: HSTPTR
    TYPE(C_DEVPTR) :: DEVPTR
  ...
  REAL(4), POINTER :: PTR (:,:)
  INTEGER :: AFTER
  INTEGER(KIND=8) :: IPREVIOUS_STRIDE, ITHIS_STRIDE, ISIZE
  INTEGER :: J, LB(2)
