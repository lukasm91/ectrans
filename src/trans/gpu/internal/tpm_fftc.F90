...
PRIVATE
PUBLIC EXECUTE_DIR_FFT, EXECUTE_INV_FFT, PLAN_DIR_FFT, PLAN_INV_FFT, TMPBUF
...
INTEGER(C_INT8_T), POINTER :: TMPBUF(:)
...
FUNCTION PLAN_DIR_FFT_FLOAT(DUMMY,KFIELD,LOENS,OFFSETS)
  ...
  INTEGER(KIND=JPIM),INTENT(IN)  :: LOENS(:), OFFSETS(:)
  INTERFACE
    FUNCTION PLAN_DIR_FFT_FLOAT_C(KFIELD,LOENS,OFFSETS,NFFT) BIND(C, name="plan_dir_fft_float")
      USE ISO_C_BINDING
  ...
  PLAN_DIR_FFT_FLOAT = PLAN_DIR_FFT_FLOAT_C(KFIELD,LOENS,OFFSETS,SIZE(LOENS))

END FUNCTION
FUNCTION PLAN_DIR_FFT_DOUBLE(DUMMY,KFIELD,LOENS,OFFSETS)
  USE PARKIND_ECTRANS ,ONLY : JPIM, JPIB
  ...
  INTEGER(KIND=JPIM),INTENT(IN)  :: LOENS(:), OFFSETS(:)
  INTERFACE
    FUNCTION PLAN_DIR_FFT_DOUBLE_C(KFIELD,LOENS,OFFSETS,NFFT) BIND(C, name="plan_dir_fft_double")
      USE ISO_C_BINDING
  ...
  PLAN_DIR_FFT_DOUBLE = PLAN_DIR_FFT_DOUBLE_C(KFIELD,LOENS,OFFSETS,SIZE(LOENS))

END FUNCTION

FUNCTION PLAN_INV_FFT_FLOAT(DUMMY,KFIELD,LOENS,OFFSETS)
  USE PARKIND_ECTRANS ,ONLY : JPIM, JPIB
  ...
  INTEGER(KIND=JPIM),INTENT(IN)  :: LOENS(:), OFFSETS(:)
  INTERFACE
    FUNCTION PLAN_INV_FFT_FLOAT_C(KFIELD,LOENS,OFFSETS,NFFT) BIND(C, name="plan_inv_fft_float")
      USE ISO_C_BINDING
  ...
  PLAN_INV_FFT_FLOAT = PLAN_INV_FFT_FLOAT_C(KFIELD,LOENS,OFFSETS,SIZE(LOENS))
END FUNCTION

FUNCTION PLAN_INV_FFT_DOUBLE(DUMMY,KFIELD,LOENS,OFFSETS)
  USE PARKIND_ECTRANS ,ONLY : JPIM, JPIB
  ...
  INTEGER(KIND=JPIM),INTENT(IN)  :: LOENS(:), OFFSETS(:)
  INTERFACE
    FUNCTION PLAN_INV_FFT_DOUBLE_C(KFIELD,LOENS,OFFSETS,NFFT) BIND(C, name="plan_inv_fft_double")
      USE ISO_C_BINDING
  ...
  PLAN_INV_FFT_DOUBLE = PLAN_INV_FFT_DOUBLE_C(KFIELD,LOENS,OFFSETS,SIZE(LOENS))
END FUNCTION
END MODULE TPM_FFTC
